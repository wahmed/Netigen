...
<form action="writeimpare.php" method="post">
    ...
    <tr style="color: #fff; background: Black;"><td>Up-Link Rate:</td> <td> <input type="number" maxlength="6" size="6" name="upLinkRate" value = "10"> Mbps</td></tr>
...
<table>
    ...
    <tr style="color: #fff; background: Black;"><td>Down-Link Rate:</td> <td> <input type="number" maxlength="6" size="6" name="downLinkRate" value = "20"> Mbps</td></tr>
